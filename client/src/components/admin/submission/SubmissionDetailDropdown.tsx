...
const SubmissionDetailDropdown = memo(({ submissionId, onClose }: SubmissionDetailDropdownProps) => {
        ...
        {isLoading ? (
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
              <h2 className="text-xl font-bold text-gray-800">Chi tiết bài nộp</h2>
              <button
                onClick={onClose}
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-4">{submission.title}</h3>
              ...
              <div className="space-y-3">
                ...
                {submission.abstract && (
                  <div>
                    ...
                    <p className="text-gray-600 whitespace-pre-wrap text-sm">{submission.abstract}</p>
                  </div>
                )}
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Phản biện</h3>
                    ...
                    return (
                      <div key={review.id} className="bg-white border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="p-3 bg-gray-50 rounded-lg">
                          <p className="text-gray-700 whitespace-pre-wrap text-sm">{review.commentForAuthor}</p>
                        </div>

                        {review.commentForPC && (
                          <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <p className="text-xs font-medium text-blue-800 mb-1">Nhận xét cho Ban Chương trình:</p>
                            <p className="text-blue-700 whitespace-pre-wrap text-xs">{review.commentForPC}</p>
                          </div>
                        )}
...
SubmissionDetailDropdown.displayName = 'SubmissionDetailDropdown';

export default SubmissionDetailDropdown;
