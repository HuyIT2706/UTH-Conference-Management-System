...
import { useGetConferenceByIdQuery, useUpdateConferenceMutation, useSetCfpSettingsMutation } from '../../../redux/api/conferencesApi';
  ...
  useEffect(() => {
    if (conferenceDetail?.data) {
      ...
      setConferenceFormData({
        name: conf.name || '',
        startDate: conf.startDate ? new Date(conf.startDate).toISOString().slice(0, 16) : '',
        endDate: conf.endDate ? new Date(conf.endDate).toISOString().slice(0, 16) : '',
        venue: conf.venue || '',
  ...
  const handleUpdateConference = async (e: React.FormEvent) => {
    ...
    try {
      await updateConference({
        ...
        startDate: conferenceFormData.startDate ? new Date(conferenceFormData.startDate).toISOString() : undefined,
        endDate: conferenceFormData.endDate ? new Date(conferenceFormData.endDate).toISOString() : undefined,
  ...
  const handleUpdateCfp = async (e: React.FormEvent) => {
    ...
    try {
      await setCfpSettings({
        conferenceId,
        submissionDeadline: new Date(cfpFormData.submissionDeadline).toISOString(),
        ...
        cameraReadyDeadline: new Date(cfpFormData.cameraReadyDeadline).toISOString(),
      }).unwrap();
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <form onSubmit={handleUpdateConference} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setConferenceFormData({ ...conferenceFormData, venue: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setConferenceFormData({ ...conferenceFormData, startDate: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => setConferenceFormData({ ...conferenceFormData, endDate: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
            </div>
          </div>
          <div className="flex justify-end">
            ...
            >
              {isUpdating ? 'Đang lưu...' : 'Lưu hội nghị'}
            </button>
          </div>
        </form>
      </div>
        ...
        <form onSubmit={handleUpdateCfp} className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => setCfpFormData({ ...cfpFormData, submissionDeadline: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => setCfpFormData({ ...cfpFormData, reviewDeadline: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => setCfpFormData({ ...cfpFormData, notificationDate: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => setCfpFormData({ ...cfpFormData, cameraReadyDeadline: e.target.value })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
          <div className="flex justify-end">
